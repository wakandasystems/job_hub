...
<table class="line-items-container">
    ...
    {% for item in invoice.items %}
        <tr>
            ...
            <td>{{ item.qty }}</td>
            <td class="right">{{ item.sub_total|price_format(currency) }}</td>
            <td>{{ (item.amount * item.qty)|price_format(currency) }}</td>
        </tr>
    {% endfor %}
    ...
    {% if (invoice.amount != invoice.sub_total) %}
        <tr>
            ...
            <td class="bold">
                {{ invoice.sub_total|price_format(currency) }}
            </td>
        </tr>
    {% endif %}
    ...
    {% if invoice.tax_amount %}
        <tr>
            ...
            <td class="bold">
                {{ invoice.tax_amount|price_format(currency) }}
            </td>
        </tr>
    {% endif %}
    ...
    {% if invoice.shipping_amount %}
        <tr>
            ...
            <td class="bold">
                {{ invoice.shipping_amount|price_format(currency) }}
            </td>
        </tr>
    {% endif %}
    ...
    {% if invoice.discount_amount %}
        <tr>
            ...
            <td class="bold">
                {{ invoice.discount_amount|price_format(currency) }}
            </td>
        </tr>
    {% endif %}
    ...
    <tr>
        ...
        <td class="bold">
            {{ invoice.amount|price_format(currency) }}
        </td>
    </tr>
    </tbody>
</table>
...
<table class="line-items-container">
    ...
    <tr>
        ...
        <td class="large total">{{ invoice.amount|price_format(currency) }}</td>
    </tr>
    </tbody>
</table>
