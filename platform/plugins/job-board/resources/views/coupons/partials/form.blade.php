...
>
    <x-core::card>
        <x-core::card.header>
            <x-core::card.title>{{ trans('plugins/job-board::coupon.your_order') }}</x-core::card.title>
        </x-core::card.header>
        <x-core::card.body>
            <dl>
    ...
    @if (session('applied_coupon_code'))
        <x-core::alert>
            <div class="d-flex justify-content-between align-items-center">
                {!! BaseHelper::clean(trans('plugins/job-board::coupon.coupon_code_applied', ['code' => '<strong class="ms-1">' . session('applied_coupon_code') . '</strong>'])) !!}
                ...
                <a
                    ...
                    title="{{ trans('plugins/job-board::coupon.remove') }}"
                >
