                ...
                <x-core::table.body>
                    @foreach ($invoice->items as $item)
                        <x-core::table.body.row>
                            ...
                            <x-core::table.body.cell class="text-center" style="width: 25%">
                                {{ format_price($item->amount, $currency) }}
                            </x-core::table.body.cell>
                        </x-core::table.body.row>
                    @endforeach
                    ...
                    <x-core::table.body.row>
                        ...
                        <x-core::table.body.cell class="text-center">
                            {{ format_price($invoice->sub_total, $currency) }}
                        </x-core::table.body.cell>
                    </x-core::table.body.row>
                    @if ($invoice->tax_amount > 0)
                        <x-core::table.body.row>
                            ...
                            <x-core::table.body.cell class="text-center">
                                {{ format_price($invoice->tax_amount, $currency) }}
                            </x-core::table.body.cell>
                        </x-core::table.body.row>
                    @endif
                    @if ($invoice->shipping_amount > 0)
                        <x-core::table.body.row>
                            ...
                            <x-core::table.body.cell class="text-center">
                                {{ format_price($invoice->shipping_amount, $currency) }}
                            </x-core::table.body.cell>
                        </x-core::table.body.row>
                    @endif
                    @if ($invoice->discount_amount > 0)
                        <x-core::table.body.row>
                            ...
                            <x-core::table.body.cell class="text-center">
                                <span>{{ format_price($invoice->discount_amount, $currency) }}</span>
                    ...
                    <x-core::table.body.row>
                        ...
                        <x-core::table.body.cell class="text-center">
                            {{ format_price($invoice->amount, $currency) }}
                        </x-core::table.body.cell>
                    </x-core::table.body.row>
