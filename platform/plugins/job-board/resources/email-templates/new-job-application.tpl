                            ...
                            <table>
                                ...
                                <tr>
                                    <td align="left" style="padding: 20px 50px;">
                                        <p><strong>{{ 'plugins/job-board::email.email_templates.new_job_application_greeting' | trans }} {{ 'plugins/job-board::email.email_templates.new_job_application_received' | trans }}</strong></p>

                                        {% if job_application_name %}
                                        <p><img src="{{ site_url }}/vendor/core/core/base/images/emails/person.png"
                                                alt="From" width="20" style="margin-right: 10px;" /> {{ 'plugins/job-board::email.email_templates.new_job_application_name' | trans({'job_application_name': job_application_name}) }}</p>
                                        {% endif %}

                                        {% if job_application_position %}
                                        <p><img src="{{ site_url }}/vendor/core/core/base/images/emails/edit.png"
                                                alt="Subject" width="20" style="margin-right: 10px;" />{{ 'plugins/job-board::email.email_templates.new_job_application_position' | trans({'job_application_position': job_application_position}) }}</p>

                                        {% endif %}

                                        {% if job_application_email %}
                                        <p><img src="{{ site_url }}/vendor/core/core/base/images/emails/email.png"
                                                alt="Email" width="20" style="margin-right: 10px;" /> {{ 'plugins/job-board::email.email_templates.new_job_application_email' | trans({'job_application_email': job_application_email}) }}</p>
                                        {% endif %}

                                        {% if job_application_phone %}
                                        <p><img src="{{ site_url }}/vendor/core/core/base/images/emails/edit.png"
                                                alt="Phone" width="20" style="margin-right: 10px;" />{{ 'plugins/job-board::email.email_templates.new_job_application_phone' | trans({'job_application_phone': job_application_phone}) }}</p>
                                        {% endif %}
