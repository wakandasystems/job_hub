...
return new class () extends Migration {
    public function up(): void
    {
        if (! Schema::hasTable('jb_custom_fields_translations')) {
            Schema::create('jb_custom_fields_translations', function (Blueprint $table): void {
        ...
        if (! Schema::hasTable('jb_custom_field_options_translations')) {
            Schema::create('jb_custom_field_options_translations', function (Blueprint $table): void {
                $table->string('lang_code');
        ...
        if (! Schema::hasTable('jb_custom_field_values_translations')) {
            Schema::create('jb_custom_field_values_translations', function (Blueprint $table): void {
                $table->string('lang_code');
