...
class FunctionalAreaTable extends TableAbstract
{
    ...
    {
        $this
            ->model(FunctionalArea::class)
            ->addActions([
                EditAction::make()->route('functional-areas.edit'),
                DeleteAction::make()->route('functional-areas.destroy'),
            ]);
    }
    ...
    public function columns(): array
    {
        return [
            IdColumn::make(),
            NameColumn::make()->route('functional-areas.edit'),
            Column::make('order')
    ...
    {
        return [
            DeleteBulkAction::make()->permission('functional-areas.destroy'),
        ];
    }
