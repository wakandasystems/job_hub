        ...
        return [
            ...
            FormattedColumn::make('operations')
                ...
                ->getValueUsing(function (FormattedColumn $column) {
                    ...
                    $sendIcon = '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" aria-hidden="true" style="' . $iconStyle . '"><path d="M22 2 11 13"/><path d="m22 2-7 20-4-9-9-4Z"/></svg>';
                    ...
                    return '<div class="table-actions">'
                        ...
                        . '<button type="button" class="btn btn-sm btn-icon btn-secondary text-white btn-send-all-matching" style="color:#fff !important" data-bs-toggle="tooltip" title="Send all matching jobs now" data-preview-url="' . route('job-board.candidate-alerts.preview', $alert->id) . '" data-send-url="' . route('job-board.candidate-alerts.send-now', $alert->id) . '" data-name="' . e($alert->candidate_name) . '">' . $sendIcon . '</button>'
                        . $welcomeButton
