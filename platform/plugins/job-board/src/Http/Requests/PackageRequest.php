...
class PackageRequest extends Request
{
    public function rules(): array
    {
        return [
            ...
            'billing_cycle'         => ['nullable', 'string', Rule::in(['one_time', 'monthly', 'annual'])],
            'posts_per_cycle'       => ['nullable', 'integer', 'min:0'],
            'can_search_candidates' => ['nullable', 'boolean'],
            'is_recruiter_plan'     => ['nullable', 'boolean'],
        ];
    }
