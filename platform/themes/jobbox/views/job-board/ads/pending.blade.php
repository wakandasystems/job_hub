        ...
        <div class="row justify-content-center">
            <div class="col-lg-6 col-md-8 col-12 text-center">
                ...
                <div class="mb-4">
                    ...
                    <p class="text-muted">
                        Your ad request for <strong>{{ $placement->name }}</strong> has been received.<br>
                        Our team will verify your payment and publish your ad shortly.
                    </p>
                </div>
                ...
                <div class="card border-0 shadow-sm mb-4 text-start">
                    <div class="card-body p-4">
                        <div class="row g-2">
                            ...
                            <div class="col-5 text-muted">Placement</div>
                            <div class="col-7">{{ $placement->name }}</div>
                ...
                <a href="{{ route('public.account.ads.index') }}" class="btn btn-outline-primary">
                    Back to Advertise
                </a>
            </div>
        </div>
